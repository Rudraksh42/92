player1_name=localStorage.getItem("player_name_input1");
player2_name=localStorage.getItem("player_name_input2");
player1_score=0;
player2_score=0;
...
function send(){
    ...
    lengthdivedto=Math.floor(word.length/2);
    charAt2=word.charAt(lengthdivedto);
    console.log(charAt2);

    length_mininus_1=word.length-1;
    charAt3=word.charAt(length_mininus_1);
    console.log(charAt3);

    remove_charAt1=word.replace(charAt1,"_");
    remove_charAt2=remove_charAt1.replace(charAt2,"_");
    remove_charAt3=remove_charAt2.replace(charAt3,"_");
    questionword="<h4 id='word_display'>Question:"+remove_charAt3+"</h4>";
